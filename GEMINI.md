# GEMINI.md - Gemini CLI Instructions for clprompt

You are a Gemini CLI agent working on a Common Lisp project.
...
- **Primary**: Documentation, research, alternative implementations
- **Strengths**: Thorough analysis, clear explanations, exploring options
- **Good for**: README updates, docstrings, design docs, researching CL idioms
...
5. **Announce** in the thread:
   ...
   send_message(
     ...
     body_md="Claiming this task. Reserved: README.md",
     thread_id="bd-<id>"
   )
   ```
...
- If researching: share findings with team via messages
...
- For code changes, run tests: `(asdf:test-system :clprompt)`
...
- Docstrings are mandatory for exported symbols
